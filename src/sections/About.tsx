...
export default function About(){
    return(
        <section  className="w-screen px-10 relative flex items-center mt-35 flex-col gap-3 pb-100">
            <div className="flex flex-row items-center gap-5 ">
                <AboutCode color="gray"/>
                <h2 className="font-[poppins] text-gradient text-3xl text-center">SOBRE MI</h2>
            </div>
            <p className="text-gradient text-center opacity-80 text-base/5 md:w-1/3">
